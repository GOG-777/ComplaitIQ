...
export default function Header() {
    ...
    return (
        <>
            <header className="bg-black text-white h-20 px-6 flex items-center justify-between sticky top-0 z-50 border-b border-white/5 backdrop-blur-md bg-black/90">
                <button
                    onClick={() => navigate('/')}
            ...
            <div className={`
        fixed top-16 right-0 bottom-0 z-40 w-72 bg-black border-l border-white/5
